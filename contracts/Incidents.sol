...
// this is the percentage of all payments made on time and missed
        uint payRate;
    }
    ...
    function createVerifier(address _verifier) external isAndyChris {
        verifiers[_verifier];
    }

    function addEvidence(string memory _evidence, bool _image, uint256 _incidentID) public payable {
